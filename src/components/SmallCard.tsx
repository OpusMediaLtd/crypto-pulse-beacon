...
const SmallCard: React.FC<SmallCardProps> = ({ post }) => {
  ...
  return (
    <Link to={`/posts/${post.slug}`} className="small-card block group mb-4">
      <div className="flex gap-4">
        ...
        <div className="flex-1">
          <h3 
            className="text-base font-semibold mb-1 line-clamp-2 group-hover:text-primary transition-colors"
